...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bittron-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bittron-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bittron transaction") + "\n" +
              "  bittron-tx [options] -create [commands]   " + _("Create hex-encoded bittron transaction") + "\n" +
              "\n";
