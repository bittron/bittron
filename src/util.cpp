...
const char * const BITCOIN_CONF_FILENAME = "bittron.conf";
const char * const BITCOIN_PID_FILENAME = "bittron.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bittron";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bittron";
#else
    // Unix
    return pathRet / ".bittron";
#endif
#endif
}
